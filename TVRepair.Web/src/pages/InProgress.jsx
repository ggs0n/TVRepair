        ...
        <div className="grid-cols-2 flex gap-5 w-full items-start">
            ...
            <div className="p-4 border border-1 border-gray-300">
                <div className="mb-6 bg-green-100 p-4">
                    <h1 className="font-bold">Your TV Is being repaired</h1>
                    <h1>Payment has been received. Our technician is now working on your TV. We'll update your once the repair is completed</h1>
                </div>

                <div className="mb-6">
                    <h1 className="font-bold">Repair Details</h1>
                    <h1>Payment Date : {orders.createdDate}</h1>
                    <h1>Estimated Completion : 3 days</h1>
                    <h1>Notes : </h1>
                </div>
